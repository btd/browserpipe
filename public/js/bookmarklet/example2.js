    ...
    if(domain !== location.protocol + "//" + location.host) { //WE DO NOT RUN IT ON BROWSERPIPE
      ...
      setTimeout(function(){
        ...
        function save(parent, success) {
          ...
          xhr.send("url="+encode(e.location.href)+"&parent="+parent+"&title="+encode(doc.title)+"&width="+encode(doc.documentElement.clientWidth)+"&height="+encode(doc.documentElement.clientHeight)+"&html="+encode(doc.documentElement.outerHTML)+"&charset="+encode(doc.characterSet)+"&v=1.1");
        }
        function destroy() {
