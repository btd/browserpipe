            	...
            	<div ref="itemEditor" className="input-append add-item hide">
					<div className="control-group">    
				      <div className="controls">
						  ...
						  <div>
						  	<button onClick={this.saveItem} className="btn add-item-save" type="button"><i className="icon-ok small-font">&nbsp;Add URL</i></button>
						  	<button onClick={this.hideItemInput} className="btn add-item-cancel" type="button"><i className="icon-remove small-font"></i></button>
						</div>
					</div>
				  </div>
				</div>
