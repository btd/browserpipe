...
var PersistentStorage = require('./persistent-storage');
var Transport = require('./transport');
var oParser = require('./options-parser');
...
Bloodhound.prototype = {
  ...
  _loadPrefetch: function loadPrefetch(o) {
    ...
    if (serialized = this._readFromStorage(o.thumbprint)) {
      ...
      deferred = send(o).then(handlePrefetchResponse);
    }
  ...
  _initialize: function initialize() {
    ...
    deferred = this.prefetch ?
      this._loadPrefetch(this.prefetch) : Promise.resolve();
    ...
    function addLocalToIndex() {
      ...
      that.add(typeof local == 'function' ? local() : local);
    }
  },
  ...
  get: function get(query, cb) {
    ...
    function returnRemoteMatches(remoteMatches) {
      ...
      remoteMatches.forEach(function (remoteMatch) {
        var isDuplicate;
...
function getSorter(sortFn) {
  return typeof sortFn == 'function' ? sort : noSort;
